...
- *GPG-encrypted* credentials via =~/.authinfo.gpg= — shared by both mbsync and SMTP sending
...
2. =~/.authinfo.gpg= — GPG-encrypted credentials for all accounts (IMAP + SMTP). *Never commit this file.*
