...
** Estimates and clocking
   I need to track time for clients and projects.  This nudges me when I clock in to make sure I have an estimate set.
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (add-to-list 'org-global-properties
                  '("Effort_ALL". "0:15 0:30 1:00 2:00 3:00 4:00 6:00 7:00 8:00 12:00 16:00 40:00"))
   #+end_src
...
** Sticky agendas
   Allows you to have more than one agenda view created simultaneously.  You can quickly switch to the view without incurring an agenda rebuild by invoking the agenda custom command key that normally generates the agenda. If it already exists it will display the existing view. g forces regeneration of the agenda view.
     ...
     (setq org-capture-templates
         (quote (("t" "Todo" entry (file "~/Dropbox/Org/inbox.org")
                 ...
                 ("d" "Daybook" entry (file+olp+datetree "~/Dropbox/Org/daybook.org")
                  "* %?" :clock-keep t)
                 ("w" "Worklog" entry (file+olp+datetree "~/Dropbox/Org/worklog.org")
                  "* %?" :clock-keep t)
...
** Org Pomodoro
   I don't really use this but I'm going to keep it for a while.
   #+BEGIN_SRC emacs-lisp
...
* Lsp-mode and lsp-ui
  ...
  For information about performance inspection and tweaks check the [[https://emacs-lsp.github.io/lsp-mode/page/performance/][lsp documentation]].
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;; These language servers might need to be installed globally
       ...
       :config
        ...
        (lsp-register-custom-settings
         '(("pyls.plugins.pyls_mypy.enabled" t t)
           ...
           ("plys.plugins.flake8.enabled" t t)

           ;; Disable these as they are duplicated in flake8
...
* Magit
  ...
  <2020-11-24 Tue> This still needs attention. I Haven't looked at the bug since I first left the comment and unset the configuration.
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;; TODO: This was never working before, investigate why and fix it.
