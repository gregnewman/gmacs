...
* Email - notmuch
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package notmuch
      ...
      ;; ── Sent mail (FCC) ───────────────────────────────────────────────────
      ;; Saves a copy of each sent message into the matching local Maildir folder.
      ;; The key is a regexp matched against the From address; nil is the fallback.
      ;; mbsync pushes these back to the IMAP Sent folder on the next sync.
      (setq notmuch-fcc-dirs
            '(("greg@gregnewman.org" . "gregnewman.org/[Gmail]/Sent Mail")
              ("gnewman@nanog.org"   . "NANOG/[Gmail]/Sent Mail")
              ("newman.greg@me.com"  . "Apple/Sent Messages")
              (nil                   . "gregnewman.org/[Gmail]/Sent Mail")))
