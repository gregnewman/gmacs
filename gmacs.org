...
*** Capture templates
   ...
   (setq org-capture-templates
       (quote (("t" "todo" entry (file "~/Dropbox/Org/inbox.org")
               ...
               "* %?\n%U\n" :clock-keep t)
               ("d" "Daily Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
                (file "~/Dropbox/Org/templates/daily_review.org"))
               ("w" "Weekly Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
                (file "~/Dropbox/Org/templates/weekly_review.org"))
               ("m" "Monthly Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
...
*** Reviews
   ...
   (defun gn/daily-review ()
    (interactive)
    (let ((org-capture-templates '(("d" "Review: Daily Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
                                  (file "~/Dropbox/Org/templates/daily_review.org")))))
    (progn
      (org-capture nil "d")
   ...
   (defun gn/weekly-review ()
    (interactive)
    (let ((org-capture-templates '(("w" "Review: Weekly Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
                                  (file "~/Dropbox/Org/templates/weekly_review.org")))))
    (progn
      (org-capture nil "w")
      (org-capture-finalize t)
   ...
   (defun gn/monthly-review ()
    (interactive)
    (let ((org-capture-templates '(("m" "Review: Monthly Review" entry (file+olp+datetree "~/Dropbox/Org/gtd.org")
                                  (file "~/Dropbox/Org/templates/monthly_review.org")))))
    (progn
      (org-capture nil "m")
      (org-capture-finalize t)
...
** Agenda commands
   ...
   :  %Y-%m-%d  %a  (make-string (window-width) 95))) (org-agenda-overriding-header PAST WEEK) (org-agenda-prefix-format  %?-11t %i %-12:c% s) (org-agenda-show-log (quote clockcheck)) (org-agenda-span 7) (org-agenda-start-day -1w) (org-deadline-warning-days 0))) (agenda  ((org-agenda-overriding-header NEXT MONTH) (org-agenda-span (quote month)) (org-agenda-start-day +0d) (org-deadline-warning-days 0))) (todo PROJECT ((org-agenda-overriding-header PROJECT LIST))) (todo DONE|PROJECTDONE ((org-agenda-overriding-header Candidates to be archived))))) (2b CollectBox ((alltodo ))) (c Simple agenda view ((tags PRIORITY="A" ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote todo) (quote done)))) (org-agenda-overriding-header HIGH PRIORITY ITEMS))) (agenda ) (alltodo  ((org-agenda-skip-function (quote (or (gn/org-skip-subtree-if-priority 65) (org-agenda-skip-if nil (quote (scheduled deadline)))))))))) (1 Clients ((tags PRIORITY="A" ((org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote todo) (quote done)))) (org-agenda-overriding-header HIGH PRIORITY ITEMS))) (agenda ) (tags-todo client ((org-agenda-skip-function (quote (or (gn/org-skip-subtree-if-priority 65) (org-agenda-skip-if nil (quote (scheduled deadline)))))))))) (  Agenda ((agenda  nil) (tags-todo -CANCELLED/!NEXT ((org-agenda-overriding-header (concat Project Next Tasks (if gn/hide-scheduled-and-waiting-next-tasks   (including WAITING and SCHEDULED tasks)))) (org-agenda-skip-function (quote gn/skip-projects-and-habits-and-single-tasks)) (org-tags-match-list-sublevels t) (org-agenda-todo-ignore-scheduled gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-deadlines gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-with-date gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-sorting-strategy (quote (todo-state-down effort-up category-keep))))) (tags REFILE ((org-agenda-overriding-header Tasks to Refile) (org-tags-match-list-sublevels nil))) (tags-todo -CANCELLED/! ((org-agenda-overriding-header Stuck Projects) (org-agenda-skip-function (quote gn/skip-non-stuck-projects)) (org-agenda-sorting-strategy (quote (category-keep))))) (tags-todo -HOLD-CANCELLED/! ((org-agenda-overriding-header Projects) (org-agenda-skip-function (quote gn/skip-non-projects)) (org-tags-match-list-sublevels (quote indented)) (org-agenda-sorting-strategy (quote (category-keep))))) (tags-todo -REFILE-CANCELLED-WAITING-HOLD/! ((org-agenda-overriding-header (concat Project Subtasks (if gn/hide-scheduled-and-waiting-next-tasks   (including WAITING and SCHEDULED tasks)))) (org-agenda-skip-function (quote gn/skip-non-project-tasks)) (org-agenda-todo-ignore-scheduled gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-deadlines gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-with-date gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-sorting-strategy (quote (category-keep))))) (tags-todo -REFILE-CANCELLED-WAITING-HOLD/! ((org-agenda-overriding-header (concat Standalone Tasks (if gn/hide-scheduled-and-waiting-next-tasks   (including WAITING and SCHEDULED tasks)))) (org-agenda-skip-function (quote gn/skip-project-tasks)) (org-agenda-todo-ignore-scheduled gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-deadlines gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-with-date gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-sorting-strategy (quote (category-keep))))) (tags-todo -CANCELLED+WAITING|HOLD/! ((org-agenda-overriding-header (concat Waiting and Postponed Tasks (if gn/hide-scheduled-and-waiting-next-tasks   (including WAITING and SCHEDULED tasks)))) (org-agenda-skip-function (quote gn/skip-non-tasks)) (org-tags-match-list-sublevels nil) (org-agenda-todo-ignore-scheduled gn/hide-scheduled-and-waiting-next-tasks) (org-agenda-todo-ignore-deadlines gn/hide-scheduled-and-waiting-next-tasks))) (tags -REFILE/ ((org-agenda-overriding-header Tasks to Archive) (org-agenda-skip-function (quote gn/skip-non-archivable-tasks)) (org-tags-match-list-sublevels nil)))) nil) (N Notes tags NOTE ((org-agenda-overriding-header Notes) (org-tags-match-list-sublevels t))) (b Agenda gn/org-agenda-with-tip) (2 . COLLECT...) (f . FOCUS...) (rad All Tasks (grouped by Due Date) ((tags-todo DEADLINE<"<+0d>" ((org-agenda-overriding-header OVERDUE) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo DEADLINE="<+0d>" ((org-agenda-overriding-header DUE TODAY) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo DEADLINE="<+1d>" ((org-agenda-overriding-header DUE TOMORROW) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo DEADLINE>"<+1d>"+DEADLINE<="<+7d>" ((org-agenda-overriding-header DUE WITHIN A WEEK) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo DEADLINE>"<+7d>"+DEADLINE<="<+28d>" ((org-agenda-overriding-header DUE WITHIN A MONTH) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo DEADLINE>"<+28d>" ((org-agenda-overriding-header DUE LATER) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notdeadline)))))) (tags-todo TODO={WAIT} ((org-agenda-overriding-header WAITING FOR) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote deadline)))))) (todo  ((org-agenda-overriding-header WAITING FOR) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote deadline))))))) ((org-agenda-sorting-strategy (quote (priority-down))) (org-agenda-write-buffer-name All Tasks (grouped by Due Date))) ~/Dropbox/Org/all-tasks-by-due-date.pdf) (f. Today ((agenda  ((org-agenda-entry-types (quote (:timestamp :sexp))) (org-agenda-overriding-header (concat CALENDAR Today:  (format-time-string %a %d (current-time)))) (org-agenda-span (quote day)))) (tags-todo LEVEL=1+REFILE ((org-agenda-overriding-header COLLECTBOX (Unscheduled)))) (tags-todo DEADLINE="<+0d>" ((org-agenda-overriding-header DUE TODAY) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote notedeadline)))) (org-agenda-sorting-strategy (quote (priority-down))))) (tags-todo DEADLINE<"<+0d>" ((org-agenda-overriding-header OVERDUE) (org-qagenda-skip-function (quote (org-agenda-skip-entry-if (quote notedeadline)))) (org-agenda-sorting-strategy (quote (priority-down))))) (agenda  ((org-agenda-entry-types (quote (:scheduled))) (org-agenda-overriding-header SCHEDULED) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote todo) (quote done)))) (org-agenda-sorting-strategy (quote (priority-down time-down))) (org-agenda-span (quote day)) (org-agenda-start-on-weekday nil) (org-agenda-time-grid nil))) (todo DONE ((org-agenda-overriding-header COMPLETED)))) ((org-agenda-format-date ) (org-agenda-start-with-clockreport-mode nil))) (fh Hotlist ((tags-todo DEADLINE<"<+0d>" ((org-agenda-overriding-header OVERDUE))) (tags-todo DEADLINE>="<+0d>"+DEADLINE<="<+1w>" ((org-agenda-overriding-header DUE IN NEXT 7 DAYS))) (tags-todo DEADLINE=""+FLAGGED|DEADLINE>"<+1w>"+FLAGGED ((org-agenda-overriding-header FLAGGED)))) ((org-agenda-todo-ignore-scheduled (quote future)))) (r . REVIEW...) (ra . All Tasks...) (rt . Timesheet...) (rtd Daily Timesheet ((agenda )) ((org-agenda-log-mode-items (quote (clock closed))) (org-agenda-overriding-header DAILY TIMESHEET) (org-agenda-show-log (quote clockcheck)) (org-agenda-span (quote day)) (org-agenda-start-with-clockreport-mode t) (org-agenda-time-grid nil))) (rtw Weekly Timesheet ((agenda )) ((org-agenda-overriding-header WEEKLY TIMESHEET) (org-agenda-skip-function (quote (org-agenda-skip-entry-if (quote timestamp)))) (org-agenda-span (quote week)) (org-agenda-start-on-weekday 1) (org-agenda-start-with-clockreport-mode t) (org-agenda-time-grid nil))) (rc . Calendar...) (rc7 Events and appointments for 7 days ((agenda )) ((org-agenda-entry-types (quote (:timestamp :sexp))) (org-agenda-span (quote week)) (org-agenda-format-date
