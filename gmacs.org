...
* Theme
   Configuration for my dark-ish theme using zenburn.  It just works well for my eyes and for code + org.
...
* Which-key
  ...
  #+end_src
* Smart parenthesis
  SmartParens is a useful package for dealing with any paired characters like parenthesis, quotes, brackets etc.
     ...
     (setq org-capture-templates
         (quote (("t" "Todo" entry (file "~/Dropbox/Org/inbox.org")
                 ...
                 ("n" "Note" entry (file "~/Dropbox/Org/inbox.org")
                  "* %? :NOTE:\n%U\n%a\n" :clock-keep t)
                 ("j" "Journal" entry (file+olp+datetree "~/Dropbox/Org/daybook.org")
                  "* %?" :clock-keep t)
...
* Javascript
  Thanks to Chad Stovern for writing up what is working for him for React development.  It gave me some ideas to add to my configuration.  I am not yet going to try rjsx-mode.
  [[https://www.chadstovern.com/javascript-in-emacs-revisited/][Chad's writeup]]
