...
*** Capture templates
    ...
    The instruction regex starts with the tag or keyword then [[https://orgmode.org/manual/Template-expansion.html#Template-expansion][template expansions]].
       ...
       - %a annotation, normally the linnk created with org-store-link
...
** Org faces and styling
   A little styling for how headlines are displayed.
   ...
   I'm not using these right now but might later.  I know I can get these from git logs.
