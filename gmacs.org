...
* Font handling
  #+BEGIN_SRC emacs-lisp
    (set-face-attribute 'default nil :font "Monaspace Neon" :weight 'light :height 125)
    (set-face-attribute 'fixed-pitch nil :font "Monaspace Neon" :weight 'light :height 125)
