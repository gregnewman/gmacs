...
** Org-mode
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     (custom-set-faces
       '(org-level-1 ((t (:inherit outline-1 :height 1.2 :width normal :family "Fira Sans Book" :background "#1c1c1c"))))
       ...
       '(variable-pitch ((t (:family "Fira Mono" :height 100 :weight light))))
       '(fixed-pitch ((t ( :family "Fira Mon" :slant normal :weight normal :height 1.0 :width normal)))))
     ...
     (setq org-todo-keyword-faces
          '(("TODO" . (:foreground "green" :weight bold))
            ("DONE" . (:foreground "dim gray" :weight normal))
