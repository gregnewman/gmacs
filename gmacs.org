...
* Configurations
** TODO Packages
   Add a list of the installed packages for future reference and a way to update or install as a group.
...
** TODO Python
   After reading about how to setup lsp-mode I think I'm going to try it
   out for a while using the MS LSP powering VS Code.
...
** TODO Org-mode
   ...
   ;; Disable line numbers for org which fixes doubling of the line numbers.
   ;; not sure why yet.
   #+BEGIN_SRC emacs-lisp
   (defun nolineorg ()
     (global-display-line-numbers-mode 0)
   )
   (add-hook 'org-mode-hook 'nolineorg)
   #+end_src
